...
- the current `0.2.1` release line additionally ships `contextweave/managed-assets.json`
...
Current `0.2.1` release-line purpose:
...
- in the current `0.2.1` release line, `preflight_context_check.py`, `archive_logs.py`, and bridge guidance surface this file for review rather than automatically executing its natural-language rules
