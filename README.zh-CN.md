...
<p align="center">
  <img src="./i/1.png" alt="ContextWeave 对比图" />
</p>
...
当一个项目需要跨天、跨 Session、跨工具或跨协作者继续推进时，ContextWeave 的价值会更明显。

<p align="center">
  <img src="./i/2.png" alt="ContextWeave 适合哪些长期项目" />
</p>

- **研究写作**：让当前判断、证据线索和下一步写作焦点不容易漂移。
- **产品文档协作**：让范围、决策、真相源和下一步 review 更容易保持对齐。
- **软件项目协调**：让实现状态、阻塞项和下一步行动在跨会话协作中保持可见。
- **混合型长期项目**：如果一个项目同时包含多种工作形态，通用连续性路径就是更安全的默认选择。
...
- 🤖 [**SKILL.md**](./SKILL.md)：想看 Agent 如何进入 ContextWeave、选择合适 profile，并把它真正用起来时。
