#!/usr/bin/env python3
"""Safely commit a prepared ContextWeave managed file with revision checks."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Safely commit a prepared ContextWeave managed file with revision checks."
    )
...
def strip_managed_headers(file_key: str, text: str) -> str:
    ...
    for idx, line in enumerate(lines):
        ...
        if idx == 0 and candidate.startswith("<!-- contextweave:file="):
            continue
