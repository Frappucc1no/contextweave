#!/usr/bin/env python3
"""Recommend the current logical workday and append target date for ContextWeave."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Recommend the logical workday and append target date for a ContextWeave workspace."
    )
