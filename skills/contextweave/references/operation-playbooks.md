...
Use this flow whenever resuming a project with an existing ContextWeave structure.
...
In the current `0.2.1` release line, those revision-aware write helpers do not independently reread `update_protocol.md` before every write.
